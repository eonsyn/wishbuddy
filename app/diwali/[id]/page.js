...
export default async function Page({ params }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center md:px-6 py-10 bg-gradient-to-br from-orange-100 via-yellow-50 to-white">
      ...
      {/* Wish Card */}
      <div className="relative w-full   md:max-w-[60%] md:bg-white/90 md:backdrop-blur-xl md:shadow-2xl rounded-3xl px-2 py-10 text-center md:border border-orange-200">
        {/* Title */}
